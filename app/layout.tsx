...
export const metadata: Metadata = {
  title: "PeerRev",
  description: "Showcase and Review Academic Projects with Peer Feedback",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased w-full relative bg-white`}
      >
        {/* Grid Background */}
